...
- Langfuse EU free/hobby tier is sufficient for trace volume across a 2-week build (`cloud.langfuse.com` project `cmsbfzos000iead0hcz5k5ygp`).
...
| Langfuse EU project (`cmsbfzos000iead0hcz5k5ygp`) | Sendil | Keys verified against API — traces not yet proven | Low |
